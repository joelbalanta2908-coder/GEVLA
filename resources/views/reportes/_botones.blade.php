...
<div class="flex flex-wrap items-center gap-2" data-export-grupo>
    ...
    <div class="inline-flex items-center rounded-full border border-[#e6eadf] bg-white p-1 shadow-sm">
        ...
        <a href="{{ route($rutaBase, 'pdf') }}" data-export-url="{{ route($rutaBase, 'pdf') }}" target="_blank" rel="noopener"
        ...
        <a href="{{ route($rutaBase, 'excel') }}" data-export-url="{{ route($rutaBase, 'excel') }}"
        ...
        <a href="{{ route($rutaBase, 'word') }}" data-export-url="{{ route($rutaBase, 'word') }}"
