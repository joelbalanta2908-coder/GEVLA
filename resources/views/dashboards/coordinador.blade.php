...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-6 sm:flex-row sm:items-stretch">
        <a href="{{ route('coordinacion.reportes.index') }}" class="group flex items-center justify-between rounded-2xl border border-[#d8e2cf] bg-white px-4 py-3 shadow-[0_10px_28px_rgba(0,0,0,0.04)] transition hover:-translate-y-0.5 hover:border-[#b9d8a5] hover:shadow-[0_14px_34px_rgba(57,169,0,0.08)] flex-1 sm:flex-initial sm:min-w-max">
            <div>
                <p class="text-sm font-extrabold text-slate-900">Reportes</p>
                <p class="text-xs font-medium text-slate-500">Generar y exportar reportes institucionales</p>
            </div>
