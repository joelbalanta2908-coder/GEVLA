...
<body class="min-h-screen bg-slate-50 text-slate-900">
    <main class="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-10">
        ...
        <h1 class="mt-3 text-4xl font-extrabold tracking-tight">Panel del instructor</h1>
        <p class="mt-4 max-w-2xl text-slate-600">Bienvenido al espacio para registrar y revisar novedades de los aprendices.</p>
