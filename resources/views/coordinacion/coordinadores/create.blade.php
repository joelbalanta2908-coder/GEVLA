...
@section('titulo', 'Nuevo coordinador')
...
<div class="mx-auto max-w-3xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-900">Nuevo coordinador</h2>
            <p class="text-sm text-gray-500">Registra al coordinador con su cuenta de acceso al sistema.</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('coordinacion.coordinadores.store') }}" class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" name="cargo" value="{{ old('cargo') }}" maxlength="100" placeholder="Ej. Coordinador Misional"
            ...
            <div>
                ...
                <input type="text" name="dependencia" value="{{ old('dependencia') }}" maxlength="120" placeholder="Ej. Coordinación Académica"
                       class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-[#39A900] focus:outline-none focus:ring-2 focus:ring-[#39A900]/30">
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3 border-t border-gray-100 pt-5">
            ...
            <button class="rounded-lg bg-[#39A900] px-5 py-2 text-sm font-semibold text-white hover:bg-[#2D8200]">Crear coordinador</button>
        </div>
    </form>
</div>
@endsection
