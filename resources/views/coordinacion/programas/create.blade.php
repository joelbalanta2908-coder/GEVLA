...
<div class="mx-auto max-w-3xl space-y-6">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-gray-900">Nuevo programa de formación</h2>
            <p class="text-sm text-gray-500">Registra el código, nombre, nivel y duración del programa.</p>
        </div>
    </div>

    <form method="POST" action="{{ route('coordinacion.programas.store') }}" class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        @csrf
        @include('coordinacion.programas._form', ['programa' => null])
        ...
        <div class="flex justify-end gap-3 border-t border-gray-100 pt-5">
            ...
            <button class="rounded-lg bg-[#39A900] px-5 py-2 text-sm font-semibold text-white hover:bg-[#2D8200]">Crear programa</button>
        </div>
    </form>
</div>
@endsection
