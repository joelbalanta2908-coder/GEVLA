            ...
            <div class="space-y-3 rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="flex gap-2">
                        ...
                        <form method="POST" action="{{ route('coordinacion.llamados.destroy', $llamado->id_llamado) }}" class="inline"
                              data-confirm="¿Estás seguro de eliminar este llamado de atención? Esta acción no se puede deshacer."
                              data-confirm-title="Eliminar llamado de atención" data-confirm-btn="Sí, eliminar">
                            @csrf
                            @method('DELETE')
