        ...
        <form method="POST" action="{{ route('coordinacion.actas.update', $acta->id_acta) }}" class="mt-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="sancion_descripcion" rows="4" required
                          class="mt-1 w-full rounded-lg border border-gray-300 text-sm focus:border-[#39A900] focus:ring-[#39A900] px-3 py-2">{{ old('sancion_descripcion', $acta->sancion_descripcion) }}</textarea>
            </div>
