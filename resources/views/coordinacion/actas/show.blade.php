            ...
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex gap-2">
                        ...
                        <form method="POST" action="{{ route('coordinacion.actas.destroy', $acta->id_acta) }}" class="inline"
                              data-confirm="¿Estás seguro de eliminar esta acta? Esta acción no se puede deshacer."
                              data-confirm-title="Eliminar acta" data-confirm-btn="Sí, eliminar">
                            @csrf
                            @method('DELETE')
